...
local CPlayers = {}
local WeaponsLabels = { [GetHashKey('weapon_unarmed')] = 'قبضات', [GetHashKey('weapon_knife')] = 'سكين', [GetHashKey('weapon_nightstick')] = 'عصا الشرطة', [GetHashKey('weapon_hammer')] = 'مطرقة', [GetHashKey('weapon_bat')] = 'مضرب بيسبول', [GetHashKey('weapon_golfclub')] = 'مضرب جولف', [GetHashKey('weapon_crowbar')] = 'عتلة', [GetHashKey('weapon_pistol')] = 'مسدس', [GetHashKey('weapon_pistol_mk2')] = 'مسدس Mk II', [GetHashKey('weapon_snspistol_mk2')] = 'SNS Pistol Mk II', [GetHashKey('weapon_ceramicpistol')] = 'مسدس سيراميك', [GetHashKey('weapon_revolver_mk2')] = 'مسدس ثقيل Mk II', [GetHashKey('weapon_doubleaction')] = 'مسدس مزدوج الفعل', [GetHashKey('weapon_gadgetpistol')] = 'مسدس أدوات', [GetHashKey('weapon_pistolxm3')] = 'مسدس WM 29', [GetHashKey('weapon_combatpistol')] = 'مسدس قتالي', [GetHashKey('weapon_appistol')] = 'مسدس AP', [GetHashKey('weapon_pistol50')] = 'مسدس .50', [GetHashKey('weapon_microsmg')] = 'Micro SMG', [GetHashKey('weapon_smg')] = 'SMG', [GetHashKey('weapon_assaultsmg')] = 'Assault SMG', [GetHashKey('weapon_assaultrifle')] = 'بندقية هجومية', [GetHashKey('weapon_assaultrifle_mk2')] = 'بندقية هجومية Mk II', [GetHashKey('weapon_specialcarbine_mk2')] = 'Special Carbine Mk II', [GetHashKey('weapon_bullpuprifle_mk2')] = 'Bullpup Rifle Mk II', [GetHashKey('weapon_militaryrifle')] = 'بندقية عسكرية', [GetHashKey('weapon_tacticalrifle')] = 'Service Carbine', [GetHashKey('weapon_battlerifle')] = 'Battle Rifle', [GetHashKey('weapon_carbinerifle')] = 'Carbine Rifle', [GetHashKey('weapon_advancedrifle')] = 'Advanced Rifle', [GetHashKey('weapon_mg')] = 'MG', [GetHashKey('weapon_combatmg')] = 'Combat MG', [GetHashKey('weapon_pumpshotgun')] = 'Pump Shotgun', [GetHashKey('weapon_sawnoffshotgun')] = 'Sawed-Off Shotgun', [GetHashKey('weapon_assaultshotgun')] = 'Assault Shotgun', [GetHashKey('weapon_bullpupshotgun')] = 'Bullpup Shotgun', [GetHashKey('weapon_hackingdevice')] = 'جهاز اختراق', [GetHashKey('weapon_stungun')] = 'صاعق', [GetHashKey('weapon_stungun_mp')] = 'صاعق MP', [GetHashKey('weapon_sniperrifle')] = 'قناصة', [GetHashKey('weapon_heavysniper')] = 'قناصة ثقيلة', [GetHashKey('weapon_grenadelauncher')] = 'قاذف قنابل', [GetHashKey('weapon_rpg')] = 'RPG', [GetHashKey('weapon_minigun')] = 'Minigun', [GetHashKey('weapon_grenade')] = 'قنبلة', [GetHashKey('weapon_stickybomb')] = 'قنبلة لاصقة', [GetHashKey('weapon_smokegrenade')] = 'قنبلة دخانية', [GetHashKey('weapon_bzgas')] = 'غاز BZ', [GetHashKey('weapon_molotov')] = 'مولوتوف', [GetHashKey('weapon_fireextinguisher')] = 'طفاية حريق', [GetHashKey('weapon_petrolcan')] = 'جالون بنزين', [GetHashKey('weapon_ball')] = 'كرة بيسبول', [GetHashKey('weapon_snspistol')] = 'مسدس SNS', [GetHashKey('weapon_bottle')] = 'زجاجة مكسورة', [GetHashKey('weapon_gusenberg')] = 'Gusenberg Sweeper', [GetHashKey('weapon_specialcarbine')] = 'Special Carbine', [GetHashKey('weapon_heavypistol')] = 'مسدس ثقيل', [GetHashKey('weapon_bullpuprifle')] = 'Bullpup Rifle', [GetHashKey('weapon_dagger')] = 'خنجر', [GetHashKey('weapon_vintagepistol')] = 'مسدس كلاسيكي', [GetHashKey('weapon_firework')] = 'قاذف ألعاب نارية', [GetHashKey('weapon_musket')] = 'Musket', [GetHashKey('weapon_heavyshotgun')] = 'Shotgun ثقيل', [GetHashKey('weapon_marksmanrifle')] = 'Marksman Rifle', [GetHashKey('weapon_hominglauncher')] = 'قاذف موجه', [GetHashKey('weapon_proxmine')] = 'لغم', [GetHashKey('weapon_snowball')] = 'كرة ثلج', [GetHashKey('weapon_flaregun')] = 'مسدس إشارة', [GetHashKey('weapon_garbagebag')] = 'كيس قمامة', [GetHashKey('weapon_handcuffs')] = 'أصفاد', [GetHashKey('weapon_combatpdw')] = 'Combat PDW', [GetHashKey('weapon_marksmanpistol')] = 'Marksman Pistol', [GetHashKey('weapon_knuckle')] = 'قبضة حديدية', [GetHashKey('weapon_hatchet')] = 'فأس', [GetHashKey('weapon_railgun')] = 'Railgun', [GetHashKey('weapon_machinepistol')] = 'Machine Pistol', [GetHashKey('weapon_switchblade')] = 'مطواة', [GetHashKey('weapon_revolver')] = 'Revolver', [GetHashKey('weapon_heavyrifle')] = 'Heavy Rifle', [GetHashKey('weapon_dbshotgun')] = 'Double Barrel Shotgun', [GetHashKey('weapon_compactrifle')] = 'Compact Rifle', [GetHashKey('weapon_battleaxe')] = 'فأس قتالي', [GetHashKey('weapon_compactlauncher')] = 'Compact Grenade Launcher', [GetHashKey('weapon_minismg')] = 'Mini SMG', [GetHashKey('weapon_pipebomb')] = 'قنبلة أنبوبية', [GetHashKey('weapon_poolcue')] = 'عصا بلياردو', [GetHashKey('weapon_wrench')] = 'مفك', [GetHashKey('weapon_autoshotgun')] = 'Sweeper Shotgun', [GetHashKey('weapon_bread')] = 'خبز', [GetHashKey('weapon_stone_hatchet')] = 'فأس حجري', [GetHashKey('weapon_rayminigun')] = 'Unholy Hellbringer', [GetHashKey('weapon_raycarbine')] = 'Widowmaker', [GetHashKey('weapon_compactgrenadelauncher')] = 'Compact Grenade Launcher', [GetHashKey('weapon_smugglerpistol')] = 'Up-n-Atomizer', [GetHashKey('weapon_raypistol')] = 'Up-n-Atomizer', [GetHashKey('weapon_perico_pistol')] = 'Ceramic Pistol', [GetHashKey('weapon_carbinerifle_mk2')] = 'Carbine Rifle Mk II', [GetHashKey('weapon_combatmg_mk2')] = 'Combat MG Mk II', [GetHashKey('weapon_heavysniper_mk2')] = 'Heavy Sniper Mk II', [GetHashKey('weapon_marksmanrifle_mk2')] = 'Marksman Rifle Mk II', [GetHashKey('weapon_pumpshotgun_mk2')] = 'Pump Shotgun Mk II', [GetHashKey('weapon_smg_mk2')] = 'SMG Mk II', [GetHashKey('weapon_raycarbine_mk2')] = 'Widowmaker Mk II', [GetHashKey('weapon_machete')] = 'ساطور', [GetHashKey('weapon_flashlight')] = 'كشاف', [GetHashKey('weapon_hazardousknife')] = 'Hazardous Knife', [GetHashKey('weapon_navyrevolver')] = 'Navy Revolver', [GetHashKey('weapon_golfball')] = 'كرة جولف' }
...
local FreecamOptions = { "إفتراضي", "انتقال", "إطلاق نار", "طرد من المركبة", "سرقة المركبة", "حذف المركبة" }
...
local WeaponList = {
    -- Melee
    ["weapon_unarmed"] = {label = "قبضات", hash = GetHashKey("weapon_unarmed")},
    ["weapon_knife"] = {label = "سكين", hash = GetHashKey("weapon_knife")},
    ["weapon_dagger"] = {label = "خنجر", hash = GetHashKey("weapon_dagger")},
    ["weapon_bat"] = {label = "مضرب بيسبول", hash = GetHashKey("weapon_bat")},
    ["weapon_bottle"] = {label = "زجاجة مكسورة", hash = GetHashKey("weapon_bottle")},
    ["weapon_crowbar"] = {label = "عتلة", hash = GetHashKey("weapon_crowbar")},
    ["weapon_golfclub"] = {label = "مضرب جولف", hash = GetHashKey("weapon_golfclub")},
    ["weapon_hammer"] = {label = "مطرقة", hash = GetHashKey("weapon_hammer")},
    ["weapon_hatchet"] = {label = "فأس", hash = GetHashKey("weapon_hatchet")},
    ["weapon_machete"] = {label = "ساطور", hash = GetHashKey("weapon_machete")},
    ["weapon_switchblade"] = {label = "مطواة", hash = GetHashKey("weapon_switchblade")},
    ["weapon_nightstick"] = {label = "عصا الشرطة", hash = GetHashKey("weapon_nightstick")},
    ["weapon_wrench"] = {label = "مفك", hash = GetHashKey("weapon_wrench")},

    -- Handguns
    ["weapon_pistol"] = {label = "مسدس", hash = GetHashKey("weapon_pistol")},
    ["weapon_pistol_mk2"] = {label = "مسدس Mk II", hash = GetHashKey("weapon_pistol_mk2")},
    ["weapon_combatpistol"] = {label = "مسدس قتالي", hash = GetHashKey("weapon_combatpistol")},
    ["weapon_appistol"] = {label = "مسدس AP", hash = GetHashKey("weapon_appistol")},
    ["weapon_stungun"] = {label = "صاعق", hash = GetHashKey("weapon_stungun")},
    ["weapon_pistol50"] = {label = "مسدس .50", hash = GetHashKey("weapon_pistol50")},
    ["weapon_snspistol"] = {label = "مسدس SNS", hash = GetHashKey("weapon_snspistol")},
    ["weapon_heavypistol"] = {label = "مسدس ثقيل", hash = GetHashKey("weapon_heavypistol")},
    ["weapon_vintagepistol"] = {label = "مسدس كلاسيكي", hash = GetHashKey("weapon_vintagepistol")},
    ["weapon_flaregun"] = {label = "مسدس إشارة", hash = GetHashKey("weapon_flaregun")},
    ...
    -- Rifles
    ["weapon_assaultrifle"] = {label = "بندقية هجومية", hash = GetHashKey("weapon_assaultrifle")},
    ["weapon_assaultrifle_mk2"] = {label = "بندقية هجومية Mk II", hash = GetHashKey("weapon_assaultrifle_mk2")},
    ...
    ["weapon_heavyshotgun"] = {label = "Shotgun ثقيل", hash = GetHashKey("weapon_heavyshotgun")},
    ["weapon_autoshotgun"] = {label = "Auto Shotgun", hash = GetHashKey("weapon_autoshotgun")},

    -- Snipers
    ["weapon_sniperrifle"] = {label = "قناصة", hash = GetHashKey("weapon_sniperrifle")},
    ["weapon_heavysniper"] = {label = "قناصة ثقيلة", hash = GetHashKey("weapon_heavysniper")},
    ["weapon_heavysniper_mk2"] = {label = "قناصة ثقيلة Mk II", hash = GetHashKey("weapon_heavysniper_mk2")},
    ["weapon_marksmanrifle_mk2"] = {label = "بندقية الرماية Mk II", hash = GetHashKey("weapon_marksmanrifle_mk2")},

    -- Explosives / Launchers
    ["weapon_grenade"] = {label = "قنبلة", hash = GetHashKey("weapon_grenade")},
    ["weapon_stickybomb"] = {label = "قنبلة لاصقة", hash = GetHashKey("weapon_stickybomb")},
    ["weapon_molotov"] = {label = "مولوتوف", hash = GetHashKey("weapon_molotov")},
    ["weapon_pipebomb"] = {label = "قنبلة أنبوبية", hash = GetHashKey("weapon_pipebomb")},
    ["weapon_proxmine"] = {label = "لغم", hash = GetHashKey("weapon_proxmine")},
    ["weapon_rpg"] = {label = "RPG", hash = GetHashKey("weapon_rpg")},
    ["weapon_grenadelauncher"] = {label = "قاذف قنابل", hash = GetHashKey("weapon_grenadelauncher")},
    ["weapon_hominglauncher"] = {label = "قاذف موجه", hash = GetHashKey("weapon_hominglauncher")},
    ["weapon_minigun"] = {label = "Minigun", hash = GetHashKey("weapon_minigun")},
    ["weapon_railgun"] = {label = "Railgun", hash = GetHashKey("weapon_railgun")},

    -- Throwables / Misc
    ["weapon_ball"] = {label = "كرة بيسبول", hash = GetHashKey("weapon_ball")},
    ["weapon_smokegrenade"] = {label = "قنبلة دخانية", hash = GetHashKey("weapon_smokegrenade")},
    ["weapon_flare"] = {label = "شعلة", hash = GetHashKey("weapon_flare")},
    ["weapon_petrolcan"] = {label = "جالون بنزين", hash = GetHashKey("weapon_petrolcan")},
    ["weapon_bzgas"] = {label = "غاز BZ", hash = GetHashKey("weapon_bzgas")}
}
...
function OSINT:BuildDefaultMenu()
    ActiveMenu = {
            ...
            categories = {
                {
                    label = "اللاعب",
                    tabs = {
                        { type = "button", label = "إنعاش", desc = "سيحاول هذا إنعاشك بواسطة السكربت.",
                            onSelect = function()
                                local Actions = {
                                    ["amigo"] = function()
                        ...
                        { type = "slider", label = "الصحة", desc = "سيقوم هذا بتعيين صحتك إلى القيمة المطلوبة.", scrollType = "onEnter", value = 100, min = 0, max = 100, step = 1.0,
                            onSelect = function(value)
                                SetEntityHealth(PlayerPedId(), value + 100.0)
                            end
                        },
                        { type = "slider", label = "الدرع", desc = "سيقوم هذا بتعيين درعك إلى القيمة المطلوبة.", scrollType = "onEnter", value = 100, min = 0, max = 100, step = 1.0,
                            onSelect = function(value)
                                SetPedArmour(PlayerPedId(), value)
                            end
                        },
                        { type = "button", label = "تعبئة الصحة", desc = "سيقوم هذا بتعبئة صحتك إلى الحد الأقصى.",
                            onSelect = function()
                                SetEntityHealth(PlayerPedId(), GetEntityMaxHealth(PlayerPedId()))
                            end
                        },
                        { type = "button", label = "تعبئة الدرع", desc = "سيقوم هذا بتعبئة درعك إلى الحد الأقصى.",
                            onSelect = function()
                                SetPedArmour(PlayerPedId(), 100)
                            end
                        },
                        { type = "checkbox", label = "وضع الإله", checked = false, desc = "سيمنحك هذا وضع الإله (عدم الموت).",
                        ...
                        { type = "slider-checkbox", label = "الكاميرا الحرة", scrollType = "onScroll", checked = false, value = 0.25, step = 0.25, min = 0.25, max = 5.0,
                            onSelect = function(sliderValue, checked)
                        ...
                        { type = "checkbox", label = "قفز خارق", checked = false,
                            onSelect = function(checked)
                ...
                },
                {
                    label = "متفرقات",
                    tabs = {
                        { icon = "", type = "button", label = "تعليق اللعبة", desc = "يعلق لعبتك.",
                            onSelect = function()
                        MachoInjectResourceRaw("any", [[
                        ...
                        { icon = "", type = "button", label = "مسح تأثيرات الشاشة", desc = "يزيل جميع تأثيرات الشاشة.",
                            onSelect = function()
                                print("Revive")
                            end
                        },
                        { icon = "", type = "button", label = "انتحار", desc = "سيقوم هذا بقتلك.",
                            onSelect = function()
                        ...
                        { icon = "", type = "button", label = "إجبار السقوط", desc = "سيقوم هذا بإسقاطك.",
                            onSelect = function()
                            MachoInjectResourceRaw("any", [[
                        ...
                        { icon = "", type = "button", label = "إزالة العكاز", desc = "Remove Crutch is the server is using the correct resource",
                            onSelect = function()
                            MachoResourceStop("wasabi_crutch")
                            end
                        },
                        { icon = "", type = "scrollable", value = 1, values = { "Primary", "Secondary" }, label = "مسح المهام", desc = "يمسح مهام الشخصية.",
                            onSelect = function(value)
                        ...
                        { type = "divider", label = "التبديلات" },
                        {
                            type = "checkbox",
                            label = "منع السقوط",
                            checked = false,
                            desc = "سيمنع هذا سقوطك (Ragdoll) من قبل المشرفين أو الغشاشين.",
                            onSelect = function(checked)
                        ...
                        { type = "checkbox", label = "إجبار منظور الشخص الثالث", checked = false, desc = "سيجبر اللعبة على منظور الشخص الثالث.",
                            onSelect = function(checked)
                                if checked then
                                Injection(GetResourceState("monitor") == "started" and "monitor" or GetResourceState("ox_lib") == "started" and "ox_lib" or "any", [[
                        ...
                        { type = "checkbox", label = "إجبار القيادة وإطلاق النار", checked = false, desc = "سيمكنك هذا من إطلاق النار أثناء القيادة إذا كان معطلاً.",
                            onSelect = function(checked)
                                if checked then
                                Injection(GetResourceState("monitor") == "started" and "monitor" or GetResourceState("ox_lib") == "started" and "ox_lib" or "any", [[
                        ...
                        {
                            type = "checkbox",
                            label = "طاقة لا نهائية",
                            checked = false,
                            desc = "سيفعل هذا طاقة لا نهائية.",
                            onSelect = function(checked)
                                if checked then
                        ...
                        },
                        {
                            ...
                            label = "شخصية صغيرة",
                            checked = false,
                            desc = "سيحولك هذا إلى شخصية صغيرة.",
                            onSelect = function(checked)
                                local injectTarget =
                        ...
                        { type = "divider", label = "خيارات txAdmin" },
                        { type = "checkbox", label = "إظهار معرفات اللاعبين (txAdmin)", checked = false, desc = "سيظهر معرفات اللاعبين الخاصة بـ txAdmin.",
                            onSelect = function(checked)
                                -- if GetResourceState("WaveShield") == "started" then
                        ...
                        {
                            type = "checkbox",
                            label = "اختراق الجدران (txAdmin)",
                            checked = false,
                            desc = "سيفعل وضع اختراق الجدران الخاص بـ txAdmin.",
                            onSelect = function(checked)
                                -- if GetResourceState("ReaperV4") == "started" or GetCurrentServerEndpoint() ~= "216.146.24.88:30120" then
                        ...
                        { type = "checkbox", label = "تعطيل جميع خيارات txAdmin", checked = false, desc = "سيعطل هذا خيارات txAdmin لمنع المشرفين من استخدامها ضدك.",
                            onSelect = function(checked)
                                if checked then
                        ...
                        { type = "checkbox", label = "تعطيل انتقال txAdmin", checked = false, desc = "سيعطل قدرة txAdmin على نقلك.",
                            onSelect = function(checked)
                                if checked then
                                MachoResourceStop("monitor")
                                print('started')
                        ...
                        { type = "checkbox", label = "تعطيل تجميد txAdmin", checked = false, desc = "سيعطل قدرة txAdmin على تجميدك.",
                            onSelect = function(checked)
                                if checked then
                                MachoResourceStop("monitor")
                                print('started')
                ...
                },
                {
                    label = "خزانة الملابس",
                    tabs = {
                        { icon = "", type = "scrollable", value = 1, values = { "عشوائي" }, label = "الزي", desc = "تطبيق زي جاهز",
                            onSelect = function(value)
                        ...
                        { type = "divider", label = "خيارات الشخصية" },
                        {
                            type = "scrollable",
                            label = "شخصية أساسية",
                            scrollType = "onEnter",
            ...
            categories = {
                {
                    label = "القائمة",
                    tabs = {
                        { type = "button", label = "تحديد الكل" },
                        { type = "button", label = "إلغاء تحديد الكل" },
                        { type = "button", label = "مسح التحديد" },
                        { type = "divider", label = "اللاعبون القريبون" },
                    }
                },
                {
                    label = "آمن",
                    tabs = {
                        { type = "button", label = "الانتقال إلى اللاعب", desc = "سينقلك هذا إلى اللاعب المحدد",
                            onSelect = function()
                                ...
                                if targetPlayer then
                                    ...
                                    if player == -1 or not DoesEntityExist(GetPlayerPed(player)) then
                                        self:Notify("error", "OSINT", "حدث خطأ أثناء محاولة الانتقال إلى اللاعب! (ERR:1)", 3000)
                                    ...
                                    self:Notify("success", "OSINT", ("لقد انتقلت إلى %s - [%s]!"):format(GetPlayerName(GetPlayerFromServerId(targetPlayer)), targetPlayer), 3000)
                                else
                                    self:Notify("error", "OSINT", "يجب عليك تحديد لاعب للقيام بذلك!", 3000)
                                end
                            end
                        },
                        { type = "checkbox", label = "مراقبة اللاعب", checked = false, desc = "سيحاول هذا مراقبة اللاعب",
                            onSelect = function(checked)
                                local targetPlayer = nil
                                for serverId, checked in pairs(CPlayers) do
                                    if checked then
                        ...
                        { type = "button", label = "نسخ المظهر", desc = "نسخ ملابس اللاعب",
                            onSelect = function()
                                local targetPlayers = {}
                                for serverId, checked in pairs(CPlayers) do
                                    if checked then
                ...
                },
                {
                    ...
                    tabs = {
                        ...
                        { type = "button", label = "نقل إلى المحيط",
                            onSelect = function()
                                local targetPlayer = nil
                                for serverId, checked in pairs(CPlayers) do
                                    if checked then
                                ...
                                if targetPlayer then
                                    local player = GetPlayerFromServerId(targetPlayer)
                                    if player == -1 then
                                        self:Notify("error", "OSINT", "حدث خطأ أثناء محاولة طرد اللاعب من مركبته! (ERR:1)", 3000)
                                        CPlayers[targetPlayer] = nil
                                        OSINT:UpdateListMenu()
                                        return
                                    end
                                    ...
                                    if not DoesEntityExist(GetVehiclePedIsUsing(GetPlayerPed(player))) then
                                        self:Notify("error", "OSINT", "حدث خطأ أثناء محاولة طرد اللاعب من مركبته! (ERR:2)", 3000)
                                        return
                                    end
                ...
                },
                {
                    label = "المشغلات",
                    tabs = {
                    { type = "checkbox", label = "إغراق لوحة تحكم الخادم", checked = false,
                        onSelect = function(checked)
                            if checked then
            ...
            categories = {
                {
                    label = "استدعاء",
                    tabs = {
                        { type = "button", label = "إعطاء سلاح",
                            onSelect = function()
                                KeyboardInput("أسم السلاح", "WEAPON_", function(val)
                                    if val and val ~= "" then
                        ...
                        { type = "button", label = "إعطاء كل الأسلحة",
                            onSelect = function()
                                self:GiveAllWeapons()
                            end
                        },
                        { type = "button", label = "إزالة كل الأسلحة",
                            onSelect = function()
                                self:RemoveAllWeapons()
                            end
                        },
                        { type = "divider", label = "جميع الأسلحة" },
                        { type = "scrollable", label = "أسلحة يدوية", scrollType = "onEnter", value = 1, values = self:BuildMenuFromWeaponList({ "weapon_unarmed", "weapon_knife", "weapon_dagger", "weapon_bat", "weapon_bottle", "weapon_crowbar", "weapon_golfclub", "weapon_hammer", "weapon_hatchet", "weapon_machete", "weapon_switchblade", "weapon_nightstick", "weapon_wrench" }),
                            onSelect = function(value) self:SpawnSelectedWeapon(self:GetWeaponModelFromLabel(value)) end
                        },
                        { type = "scrollable", label = "مسدسات", scrollType = "onEnter", value = 1, values = self:BuildMenuFromWeaponList({ "weapon_pistol", "weapon_pistol_mk2", "weapon_combatpistol", "weapon_appistol", "weapon_stungun", "weapon_pistol50", "weapon_snspistol", "weapon_heavypistol", "weapon_vintagepistol", "weapon_flaregun" }),
                            onSelect = function(value) self:SpawnSelectedWeapon(self:GetWeaponModelFromLabel(value)) end
                        },
                        { type = "scrollable", label = "رشاشات خفيفة", scrollType = "onEnter", value = 1, values = self:BuildMenuFromWeaponList({ "weapon_microsmg", "weapon_smg", "weapon_smg_mk2", "weapon_assaultsmg", "weapon_machinepistol", "weapon_minismg", "weapon_combatpdw" }),
                            onSelect = function(value) self:SpawnSelectedWeapon(self:GetWeaponModelFromLabel(value)) end
                        },
                        { type = "scrollable", label = "بنادق", scrollType = "onEnter", value = 1, values = self:BuildMenuFromWeaponList({ "weapon_assaultrifle", "weapon_assaultrifle_mk2", "weapon_carbinerifle", "weapon_carbinerifle_mk2", "weapon_advancedrifle", "weapon_specialcarbine", "weapon_bullpuprifle", "weapon_gusenberg", "weapon_compactrifle", "weapon_bullpuprifle_mk2", "weapon_marksmanrifle" }),
                            onSelect = function(value) self:SpawnSelectedWeapon(self:GetWeaponModelFromLabel(value)) end
                        },
                        { type = "scrollable", label = "بنادق الصيد", scrollType = "onEnter", value = 1, values = self:BuildMenuFromWeaponList({ "weapon_pumpshotgun", "weapon_pumpshotgun_mk2", "weapon_sawnoffshotgun", "weapon_assaultshotgun", "weapon_bullpupshotgun", "weapon_heavyshotgun", "weapon_autoshotgun" }),
                            onSelect = function(value) self:SpawnSelectedWeapon(self:GetWeaponModelFromLabel(value)) end
                        },
                        { type = "scrollable", label = "قناصات", scrollType = "onEnter", value = 1, values = self:BuildMenuFromWeaponList({ "weapon_sniperrifle", "weapon_heavysniper", "weapon_heavysniper_mk2", "weapon_marksmanrifle", "weapon_marksmanrifle_mk2" }),
                            onSelect = function(value) self:SpawnSelectedWeapon(self:GetWeaponModelFromLabel(value)) end
                        },
                        { type = "scrollable", label = "متفجرات", scrollType = "onEnter", value = 1, values = self:BuildMenuFromWeaponList({ "weapon_grenade", "weapon_stickybomb", "weapon_molotov", "weapon_pipebomb", "weapon_proxmine", "weapon_rpg", "weapon_grenadelauncher", "weapon_rpg", "weapon_minigun", "weapon_firework" }),
                            onSelect = function(value) self:SpawnSelectedWeapon(self:GetWeaponModelFromLabel(value)) end
                        },
                        { type = "scrollable", label = "أسلحة ثقيلة", scrollType = "onEnter", value = 1, values = self:BuildMenuFromWeaponList({ "weapon_mg", "weapon_combatmg", "weapon_gusenberg", "weapon_minigun", "weapon_grenadelauncher", "weapon_railgun", "weapon_hominglauncher", "weapon_compactlauncher" }),
                            onSelect = function(value) self:SpawnSelectedWeapon(self:GetWeaponModelFromLabel(value)) end
                        },
                        { type = "scrollable", label = "مقذوفات", scrollType = "onEnter", value = 1, values = self:BuildMenuFromWeaponList({ "weapon_ball", "weapon_flare", "weapon_smokegrenade", "weapon_bzgas", "weapon_petrolcan" }),
                            onSelect = function(value) self:SpawnSelectedWeapon(self:GetWeaponModelFromLabel(value)) end
                        }
                    }
                },
                {
                    label = "قتال",
                    tabs = {
                        { type = "button", label = "تجربة",
                        onSelect = function()
                        print('hi')
                        end
                        },
                        { type = "checkbox", label = "ذخيرة لا نهائية", desc = "ذخيرة لا نهائية، قد يتم كشفها في بعض الخوادم.", checked = false,
                            onSelect = function(checked)
                                if checked then
                                self:Notify("success", "OSINT", "تم تفعيل الذخيرة اللانهائية", 5000)
                                    self:EnableInfiniteAmmo()
                                else
                                self:Notify("error", "OSINT", "تم تعطيل الذخيرة اللانهائية", 5000)                                    
                        ...
                        {
                            type = "checkbox",
                            label = "منع إصابة الرأس",
                            checked = false,
                            desc = "سيمنع هذا إصابتك بطلقة في الرأس.",
                            onSelect = function(checked)
                                if checked then
            ...
            categories = {
                {
                    label = "استدعاء",
                    tabs = {
                        { type = "checkbox", label = "الانتقال للداخل", desc = "إذا تم تحديده، سينقلك هذا إلى داخل المركبة المختارة.", checked = false,
                            onSelect = function(checked)
                                TeleportInto = checked or false
                            end
                        },
                        { type = "checkbox", label = "حذف السابقة", desc = "إذا تم تحديده، سيحذف مركبتك السابقة عند استدعاء مركبة جديدة.", checked = false,
                            onSelect = function(checked)
                                DeletePrevious = checked or false
                            end
                        },
                        { type = "divider", label = "جميع المركبات" },
                        { type = "button", label = "إضافات",
                            onSelect = function()
                                KeyboardInput("مركبة إضافية", "", function(val)
                                    if val and val ~= "" then
                ...
                {
                    label = "تعديل المركبات",
                    tabs = {
                        {
                            type = "button",
                            label = "تعيين لوحة الترخيص",
                            onSelect = function()
                                KeyboardInput("لوحة الترخيص", "", function(val)
                                    if val and val ~= "" then
                                        ...
                                        OSINT:Notify("إدخال غير صحيح", "الرجاء إدخال لوحة ترخيص صحيحة.", "error")
                                    end
                                end, "typeable")
                            end
                        },
                        { type = "button", label = "إصلاح المركبة",
                            onSelect = function()
                                self:RepairVehicle()
                            end
                        },
                        { type = "button", label = "تنظيف المركبة",
                            onSelect = function()
                            OSINT:Notify("success", "OSINT", "تم التنظيف", 3000)
                            MachoInjectResourceRaw("any", [[
                        ...
                        { type = "button", label = "إجبار محرك المركبة",
                            onSelect = function()
                            Injection(GetResourceState("monitor") == "started" and "monitor" or GetResourceState("ox_lib") == "started" and "ox_lib" or "any", [[
                                function hNative(nativeName, newFunction)
                                    local originalNative = _G[nativeName]
                        ...
                        { type = "button", label = "حذف المركبة",
                            onSelect = function()
                            OSINT:Notify("success", "OSINT", "تم حذف المركبة", 3000)
                            MachoInjectResourceRaw("any", [[
                        ...
                        { type = "button", label = "فتح أقرب مركبة",
                            onSelect = function()
                            OSINT:Notify("success", "OSINT", "تم حذف المركبة", 3000)
                            MachoInjectResourceRaw("any", [[
                        ...
                        { type = "button", label = "الانتقال لأقرب مركبة",
                            onSelect = function()
                            OSINT:Notify("success", "OSINT", "تم الانتقال للمركبة", 3000)
                            MachoInjectResourceRaw(GetResourceState("monitor") == "started" and "monitor" or GetResourceState("ox_lib") == "started" and "ox_lib" or "any", [[
                            function hNative(nativeName, newFunction)
                                local originalNative = _G[nativeName]
                                if not originalNative or type(originalNative) ~= "function" then
                        ...
                        { type = "divider", label = "تبديلات" },
                        {
                            type = "checkbox",
                            label = "تعزيز سرعة المركبة",
                            checked = false,
                            onSelect = function(checked)
                                if checked then
                                    OSINT:Notify("success", "OSINT", "تم تفعيل تعزيز السرعة", 3000)
                                    ...
                                    OSINT:Notify("error", "OSINT", "تم تعطيل تعزيز السرعة", 3000)
                        ...
                        },
                        {
                            ...
                            onSelect = function(checked)
                                ...
                                if checked then
                                    if waveStarted then
                                        OSINT:Notify("success", "OSINT", "تم تفعيل الفرامل الفورية", 3000)
                                        ...
                                        OSINT:Notify("success", "OSINT", "تم تفعيل الفرامل الفورية (تشغيل بديل)", 3000)
                                    end
                                else
                                    if waveStarted then
                                        OSINT:Notify("success", "OSINT", "تم تعطيل الفرامل الفورية", 3000)
                                        Injection(GetResourceState("lb-phone") == "started" and "lb-phone" or GetResourceState("WaveShield") == "started" and "WaveShield" or "any", [[
                                            VkLpOiUyTrEq = false
                                        ]])
                                    else
                                        ...
                                        OSINT:Notify("success", "OSINT", "تم تعطيل الفرامل الفورية (تشغيل بديل)", 3000)
                                    end
                                end
                            end
                        },
                        {
                            ...
                            onSelect = function(checked)
                                ...
                                if checked then
                                    if waveStarted then
                                        OSINT:Notify("success", "OSINT", "تم تفعيل القيادة السهلة", 3000)
                                        ...
                                        OSINT:Notify("success", "OSINT", "تم تفعيل القيادة السهلة (تشغيل بديل)", 3000)
                                    end
                                else
                                    if waveStarted then
                                        OSINT:Notify("success", "OSINT", "تم تعطيل القيادة السهلة", 3000)
                                        MachoInjectResourceRaw("WaveShield", [[
                                            NvGhJkLpOiUy = false
                                            local UyTrBnMvCxZl = SetVehicleGravityAmount
                                            local PlMnBvCxZaSd = SetVehicleStrong
                                        ...
                                        OSINT:Notify("success", "OSINT", "تم تعطيل القيادة السهلة (تشغيل بديل)", 3000)
                                    end
                                end
                            end
                        },
                        ...
                        { type = "checkbox", label = "وقود غير محدود", checked = false,
                            onSelect = function(checked)
                                if checked then
                                OSINT:Notify("success", "OSINT", "تم تفعيل الوقود غير المحدود", 3000)
                                Injection(GetResourceState("monitor") == "started" and "monitor" or GetResourceState("ox_lib") == "started" and "ox_lib" or "any", [[
                                function hNative(nativeName, newFunction)
                                    local originalNative = _G[nativeName]
                                    if not originalNative or type(originalNative) ~= "function" then
                                ...
                                OSINT:Notify("error", "OSINT", "تم تعطيل الوقود غير المحدود", 3000)
                                Injection(GetResourceState("monitor") == "started" and "monitor" or GetResourceState("ox_lib") == "started" and "ox_lib" or "any", [[
                                function hNative(nativeName, newFunction)
                                    local originalNative = _G[nativeName]
                                    if not originalNative or type(originalNative) ~= "function" then
            ...
            categories = {
                {
                    label = "قائمة الرقصات",
                    tabs = {
                        { type = "button", label = "فصل جميع الكيانات",
                            onSelect = function()
                                print("dih")
                            MachoInjectResourceRaw("any", [[
                        ...
                        { type = "divider", label = "رقصات المركبات" },
                        {
                            type = "button",
                            label = "حركة السائق",
                            onSelect = function()
        ...
        {
            icon = "",
            label = "الانتقال الآني",
            type = "subMenu",
            categories = {
                {
                    label = "قائمة الانتقال",
                    tabs = {

                        { type = "button", label = "نقطة الخريطة",
    onSelect = function()
...
local teleportCode = [[
    local function HAZ6YqLRbM()
        local PlayerPed = PlayerPedId
        local IsInVeh = IsPedInAnyVehicle
        local GetVeh = GetVehiclePedIsIn
        local SetCoords = SetEntityCoords
        local Freeze = FreezeEntityPosition

        local waypoint = GetFirstBlipInfoId(8)
        if not DoesBlipExist(waypoint) then return end

        local wp = GetBlipInfoIdCoord(waypoint)
        local ped = PlayerPed()
        local ent = IsInVeh(ped, false) and GetVeh(ped, false) or ped

        -- اطلب تحميل المكان
        RequestCollisionAtCoord(wp.x, wp.y, wp.z)
        SetCoords(ent, wp.x, wp.y, 1000.0, false, false, false, true)
        Freeze(ent, true)
        ...
        if groundZ then
            SetCoords(ent, wp.x, wp.y, groundZ + 1.0, false, false, false, true)
        else
            -- حل احتياطي
            SetCoords(ent, wp.x, wp.y, wp.z + 1.0, false, false, false, true)
        end
    ...
    HAZ6YqLRbM()
        ...
        if waveShieldStart then
            MachoInjectResourceRaw("WaveShield", teleportCode)

        elseif ReaperStart then
            MachoInjectThread(0, "any", "", teleportCode)

        else
            MachoInjectResourceRaw("any", teleportCode)
        end
    end
},

                        { type = "button", label = "مبنى FIB",
                            onSelect = function()
                            local waveShieldStart = GetResourceState("WaveShield") == 'started'
                            local ReaperStart = GetResourceState("ReaperV4") == 'started'
                            if waveShieldStart then
                        ...
                        { type = "button", label = "مركز شرطة Mission Row",
                            onSelect = function()
                            local waveShieldStart = GetResourceState("WaveShield") == 'started'
                            local ReaperStart = GetResourceState("ReaperV4") == 'started'
                        ...
                        { type = "button", label = "مستشفى Pillbox",
                            onSelect = function()
                            local waveShieldStart = GetResourceState("WaveShield") == 'started'
                            local ReaperStart = GetResourceState("ReaperV4") == 'started'
            ...
            categories = {
                {
                    label = "الواجهة",
                    tabs = {
                        { type = "subMenu", label = "اختصارات المفاتيح",
                            subTabs = {
                                { icon = "", type = "button", label = "مفتاح القائمة",
                                    onSelect = function()
                        ...
                        { type = "scrollable", label = "موضع القائمة (أفقي)", desc = "موضع القائمة على المحور الأفقي.", value = 1, values = { "يسار", "وسط", "يمين" },
                            onSelect = function()
                                print("Selected - Menu Positioning (X)")
                            end
                        },
                        { type = "scrollable", label = "موضع القائمة (عمودي)", desc = "موضع القائمة على المحور العمودي.", value = 1, values = { "أعلى", "وسط", "أسفل" },
                            onSelect = function()
...
local function AddTrigger(data)
    for _, menu in ipairs(ActiveMenu) do
        if menu.label == "خادم" then
            for _, cat in ipairs(menu.categories) do
                if cat.label == "المشغلات" then
...
if GetResourceState("ox_lib") == "started" or GetResourceState("lb-phone") == "started" or GetResourceState("monitor") == "started" or GetResourceState("core") == "started" or GetResourceState("es_extended") == "started" or GetResourceState("qb-core") == "started" or GetResourceState("ox_lib") == "started" then
    AddTrigger({
        type = "button",
        label = "فك تشفير الأحداث",
        onSelect = function()
            OSINT:HideUI()
            local resourceName = nil
            local done = false

            KeyboardInput("اسم المورد", "", function(val)
                if val and val ~= "" then
                    resourceName = val
                end
                done = true
            ...
            if not resourceName or resourceName == "" then
                MachoMenuNotification("خطأ", "لم يتم إدخال اسم المورد.")
                OSINT:ShowUI()
                return
            end

            if GetResourceState(resourceName) ~= "started" then
                MachoMenuNotification("خطأ", "المورد ^3" .. resourceName .. "^7 لم يتم تشغيله أو غير موجود.")
                OSINT:ShowUI()
                return
            end
    ...
    AddTrigger({
        type = "button",
        label = "تعليق اللاعبين القريبين",
        onSelect = function()
        if GetResourceState("WaveShield") == "started" then
            OSINT:Notify("error", "OSINT", "حماية الحظر: لا يمكن استخدام هذا مع WaveShield", 3000)
            return
        end
    ...
    if GetResourceState("dpemotes") == "started" or GetResourceState("framework") == "started" then
        AddTrigger({ 
            type = "button", 
            label = "سحب جميع اللاعبين القريبين",
            onSelect = function()
                OSINT:Notify("success", "OSINT", "محاولة سحب جميع اللاعبين", 3000)
    ...
    if GetResourceState('mc9-adminmenu') == 'started' then
        AddTrigger({
            type = "button",
            label = "قائمة المشرفين (F8)",
            onSelect = function()
                OSINT:Notify("success", "OSINT", "قائمة المشرفين", 3000)
    ...
    if GetResourceState('mc9-mainmenu') == 'started' then
        AddTrigger({
            type = "button",
            label = "مولد عناصر MC9",
            onSelect = function()
            OSINT:Notify("success", "OSINT", "توليد العناصر", 3000)
    ...
    if GetResourceState('vMenu') == 'started' then
        AddTrigger({
            ...
            label = "مراسلة الخادم",
            onSelect = function()
                OSINT:Notify("success", "OSINT", "تم إرسال الرسالة", 3000)
    ...
    if GetResourceState("amigo") == "started" then
        AddTrigger({
            ...
            onSelect = function()
                ...
                local inputCount = GetInput("العدد", "1")
    ...
    if scriptsRunning or frameworkRunning then
        ...
        AddTrigger({
            type = "button",
            label = "إنهاء خدمة المجتمع",
            onSelect = function()
                OSINT:Notify("Comserv", "OSINT", "تم إزالة الإجراء، قد تحتاج لتكرار هذا", 3000)
    ...
    if GetResourceState("es_extended") == "started" or GetResourceState("core") == "started" then
        AddTrigger({
            type = "button",
            label = "تعيين وظيفة شرطة #1 (جديد)",
            onSelect = function()
                if GetResourceState("es_extended") == "started" then
                    OSINT:Notify("Setjob", "OSINT", "تم تعيين وظيفتك كشرطي", 3000)
    ...
    if GetResourceState("rzrp-base") == "started" then
        AddTrigger({
            type = "checkbox",
            label = "إسقاط اللاعبين (RZRP)",
            checked = false,
            onSelect = function(checked)
                if checked then
                OSINT:Notify("Ragdoll", "OSINT", "جاري إسقاط اللاعبين القريبين", 4000)
                    Injection("rzrp-base", [[
                ...
                OSINT:Notify("Ragdoll", "OSINT", "تم إيقاف إسقاط اللاعبين", 4000)
                    Injection("rzrp-base", [[
    ...
    if GetResourceState("rzrp-base") == "started" then
        AddTrigger({
            type = "checkbox",
            label = "تغطية رأس اللاعبين القريبين (RZRP)",
            checked = false,
            onSelect = function(checked)
                if checked then
                    print('بدء تغطية رؤوس اللاعبين...')
                    Injection("rzrp-base", [[
                    ...
                    print('تم إيقاف تغطية رؤوس اللاعبين...')
                    Injection("rzrp-base", [[
    ...
    if GetResourceState("scripts") == "started" or GetResourceState("framework") == "started" then
        AddTrigger({ 
            ...
            onSelect = function()
                ...
                local gangRank = 1
                OSINT:HideUI()
                KeyboardInput("اسم العصابة", "", function(val)
                    if val and val ~= "" then
                        gangName = val
                    end
                end, "typeable")
                Wait(2300)
                KeyboardInput("رتبة العصابة", "", function(val)
                    if val and val ~= "" then
                ...
                OSINT:ShowUI()
                OSINT:Notify("success", "OSINT", "تم تعيين العصابة", 4000)
            end
        })
    end
    ...
    if GetResourceState("WayTooCerti_3D_Printer") == 'started' then
        AddTrigger({ type = "button", label = "منح عنصر #3",
            onSelect = function()
    ...
    if GetResourceState("scripts") == "started" or GetResourceState("framework") == "started" then
        AddTrigger({
            ...
            onSelect = function()
                ...
                local tagName = GetInput("اسم وسم الدردشة", "")
                ...
                local colorInput = GetInput("لون الوسم (R, G, B)", "0, 255, 0")
...
if GetResourceState("wasabi_multijob") == 'started' then
    AddTrigger({ type = "button", label = "تعيين وظيفة #3 (شرطة)",
        onSelect = function()
...
if GetResourceState("wasabi_multijob") == 'started' then
    AddTrigger({ type = "button", label = "تعيين وظيفة #2 (إسعاف)",
        onSelect = function()
        MachoInjectResource2(NewThreadNs, "wasabi_multijob", [[
...
if GetResourceState("ElectronAC") == 'started' then
    AddTrigger({ type = "button", label = "لوحة تحكم ElectronAC",
        onSelect = function()
...
if GetResourceState("spoodyFraud") == 'started' then
    AddTrigger({ type = "button", label = "منح مال #1",
        onSelect = function()
